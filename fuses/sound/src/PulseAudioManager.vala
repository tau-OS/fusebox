    ...
    private void card_info_callback (PulseAudio.Context c, PulseAudio.CardInfo? card, int eol) {
        ...
        foreach (var port in relevant_ports) {
            ...
            if (device.icon_name == null && device.form_factor != null) {
                ...
                case "car":
                    device.icon_name = "audio-car-symbolic";
                    break;
                case "computer":
                case "internal":
                    device.icon_name = "computer-symbolic";
                    break;
                case "handset":
                    device.icon_name = "phone-symbolic";
                    break;
                case "headphone":
                ...
                case "headset":
                    ...
                    break;
                case "hifi":
                    device.icon_name = "audio-subwoofer-symbolic";
                    break;
                case "microphone":
                    device.icon_name = "audio-input-microphone-symbolic";
                    break;
                case "portable":
                case "speaker":
                    device.icon_name = "bluetooth-symbolic";
                    break;
                case "tv":
                    device.icon_name = "video-display-tv-symbolic";
                    break;
                case "webcam":
                    device.icon_name = "camera-web-symbolic";
                    break;
                }
            }
            ...
            if (device.icon_name == null) {
                device.icon_name = is_input ? "audio-input-microphone-symbolic" : "audio-card-symbolic";
            }

            // audio card is currently represented by a speaker
            if (is_input && device.icon_name.has_prefix ("audio-card-symbolic")) {
                device.icon_name = "audio-input-microphone-symbolic";
            }
